...
EXPORT opt_t sysopts[]={
    ...
    {"stats-eratio1",   1,  (void *)&prcopt_.eratio[NFREQ],   ""},
    {"stats-eratio2",   1,  (void *)&prcopt_.eratio[NFREQ+1], ""},
    {"stats-eratio5",   1,  (void *)&prcopt_.eratio[NFREQ+2], ""},
    {"stats-ceratio1",  1,  (void *)&prcopt_.eratio[0],  ""     },
    {"stats-ceratio2",  1,  (void *)&prcopt_.eratio[1],  ""     },
    {"stats-ceratio5",  1,  (void *)&prcopt_.eratio[2],  ""     },
